...
def build_models_and_optim(args, device):
    ...
    if need_encoder:
        ...
        if args.freeze_encoder:
            ...
            if is_main_process():
                print("⚙️ 冻结 encoder，仅训练 decoder。")
...
def parse_args():
    ...
    ap.add_argument(
        "--train_root",
        type=str,
        default=r"/2024219001/data/cocoa/train",
    )
    ap.add_argument(
        "--val_root",
        type=str,
        default=r"/2024219001/data/cocoa/test",
    )
    ...
    ap.add_argument("--out", type=str, default="runs/acocoa_ddpfull_ll_e8_r32")
    ap.add_argument("--resume", type=str, default="./runs/exp_ddpfull_ll_e8_r32/epoch_001.pt")
